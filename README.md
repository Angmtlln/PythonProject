# Telegram Bot with Neural Network Image Conversion

This project implements a Telegram bot that receives photos from users and applies a neural network to generate a hand-drawn version of the image. It provides a fun and creative way to transform images into artistic renditions using deep learning techniques.

## Features

+ Telegram Bot Integration: The project includes a Telegram bot that users can interact with by sending photos to receive hand-drawn versions.
+ Neural Network Image Conversion: The bot utilizes a trained neural network model to convert the received photo into a hand-drawn representation.
